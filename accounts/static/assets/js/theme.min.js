...
! function() {
    ...
    if ($("#dataTableBasic").length && $(document).ready((function() {
        ...
        a && a.addEventListener("click", (function() {
            var e, t, a;
            e = "Nice, you triggered this alert message!", t = "success", (a = document.createElement("div")).innerHTML = '<div class="alert alert-' + t + ' alert-dismissible" role="alert">' + e + '<button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button></div>', n.append(a)
        }))
    }
